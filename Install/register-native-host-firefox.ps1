# Registers the Firefox native messaging host manifest for SekoDL.
...
$InstalledManifestPath = Join-Path $PSScriptRoot "sekodl.nativehost.firefox.json"
$RepoManifestPath = "C:\Users\ahmedseko\Documents\GitHub\sdm\SekoDL\Install\sekodl.nativehost.firefox.json"
...
$RegistryKey = "Registry::HKEY_CURRENT_USER\Software\Mozilla\NativeMessagingHosts\com.sekodl.bridge"
...
Write-Host "Firefox native host registered: $ManifestPath"
